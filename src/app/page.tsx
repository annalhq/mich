  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-2 pt-2">
      ...
      <div className="w-full flex-col px-4 pt-4 md:w-2/3 lg:w-1/2">
        ...
        {/* Bio Section */}
        <p className="mt-8 text-[16px] text-gray-300 md:text-[18px]">
          hey there 👋. i like{" "}
          <span className="text-white">machine learning</span>,{" "}
          <span className="text-white">mathematics</span> and{" "}
          <span className="text-white">particle physics</span>.
        </p>
        <p className="mt-4 text-[16px] text-gray-300 md:text-[18px]">
        ...
        <p className="mt-4 text-[16px] text-gray-300 md:text-[18px]">
          currently implementing papers from{" "}
          <Link
            href="https://nlp.seas.harvard.edu/code/"
            className="text-white underline"
          >
            harvard nlp
          </Link>{" "}
          and{" "}
          <Link href="https://nn.labml.ai/" className="text-white underline">
            labml
          </Link>
        </p>
        ...
        {/* Blogs Section */}
        <h1 className="mb-2 mt-8 font-serif text-[16px] text-white md:text-[18px]">
        ...
        <ul className="list-inside">
          {recentBlogs.map((blog, index) => (
            <li key={index} className="my-3 w-full cursor-pointer md:my-4">
              ...
              >
                <p className="text-[16px] lowercase text-white">
                  {index + 1}. {blog.title}
                </p>
