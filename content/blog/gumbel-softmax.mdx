...
In [DALLE](https://arxiv.org/pdf/2102.12092), they want to maximize $\ln{p_{\theta}, \psi (x,y)}$ and by _ELBO_, they derive the lower bound to be:
...
The Gumbel Softmax heavily utilizes the results from ([Maddison et al](https://arxiv.org/pdf/1611.00712.pdf)), where the authors present the Concrete distribution: 
...
---
P.S: This blog is taken from jyopari's blog, which is a great resource for understanding Gumbel Softmax and its applications in deep learning. I am just testing the MDX format for my blog.
Reference:
- [Gumbel Softmax](https://jyopari.github.io/posts/gumbel)